...
// Parameters:
// class APlayerController*                Player                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FPlayerInputMappings             Mappings                                               (Parm, OutParm, NativeAccessSpecifierPublic)

void UInputMappingManager::SetPlayerInputMappingsStatic(class APlayerController* Player, struct FPlayerInputMappings* Mappings)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("InputMappingManager", "SetPlayerInputMappingsStatic");

	Params::InputMappingManager_SetPlayerInputMappingsStatic Parms{};
	...
	if (Mappings != nullptr)
		*Mappings = std::move(Parms.Mappings);
}
