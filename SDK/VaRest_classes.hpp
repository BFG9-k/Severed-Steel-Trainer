...
{
public:
	TMulticastInlineDelegate<void(class UVaRestRequestJSON* Request)> OnRequestComplete;                                 // 0x0028(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UVaRestRequestJSON* Request)> OnRequestFail;                                     // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_F8[0xD0];                                      // 0x00F8(0x00D0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UVaRestRequestJSON) == 0x0001C8, "Wrong size on UVaRestRequestJSON");
...
static_assert(offsetof(UVaRestRequestJSON, ResponseJsonObj) == 0x0000E8, "Member 'UVaRestRequestJSON::ResponseJsonObj' has a wrong offset!");
static_assert(offsetof(UVaRestRequestJSON, ResponseJsonValue) == 0x0000F0, "Member 'UVaRestRequestJSON::ResponseJsonValue' has a wrong offset!");
