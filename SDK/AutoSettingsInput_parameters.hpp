...
// Function AutoSettingsInput.InputMappingManager.SetPlayerInputMappingsStatic
// 0x00A8 (0x00A8 - 0x0000)
struct InputMappingManager_SetPlayerInputMappingsStatic final
{
public:
	class APlayerController*                      Player;                                            // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPlayerInputMappings                   Mappings;                                          // 0x0008(0x00A0)(Parm, OutParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(InputMappingManager_SetPlayerInputMappingsStatic) == 0x000008, "Wrong alignment on InputMappingManager_SetPlayerInputMappingsStatic");
static_assert(sizeof(InputMappingManager_SetPlayerInputMappingsStatic) == 0x0000A8, "Wrong size on InputMappingManager_SetPlayerInputMappingsStatic");
static_assert(offsetof(InputMappingManager_SetPlayerInputMappingsStatic, Player) == 0x000000, "Member 'InputMappingManager_SetPlayerInputMappingsStatic::Player' has a wrong offset!");
static_assert(offsetof(InputMappingManager_SetPlayerInputMappingsStatic, Mappings) == 0x000008, "Member 'InputMappingManager_SetPlayerInputMappingsStatic::Mappings' has a wrong offset!");
