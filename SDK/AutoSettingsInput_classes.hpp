...
{
public:
	int32                                         MappingGroup;                                      // 0x0260(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInputLabel) == 0x000290, "Wrong size on UInputLabel");
static_assert(offsetof(UInputLabel, MappingGroup) == 0x000260, "Member 'UInputLabel::MappingGroup' has a wrong offset!");
static_assert(offsetof(UInputLabel, KeyGroup) == 0x000264, "Member 'UInputLabel::KeyGroup' has a wrong offset!");
static_assert(offsetof(UInputLabel, bUsePlayerKeyGroup) == 0x00026C, "Member 'UInputLabel::bUsePlayerKeyGroup' has a wrong offset!");
static_assert(offsetof(UInputLabel, IconTags) == 0x000270, "Member 'UInputLabel::IconTags' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UKeyLabel>                  KeyLabelWidgetClass;                               // 0x0298(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoClear, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWidget>                    KeySeparatorWidgetClass;                           // 0x02A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UActionLabel) == 0x0002F8, "Wrong size on UActionLabel");
static_assert(offsetof(UActionLabel, ActionName) == 0x000290, "Member 'UActionLabel::ActionName' has a wrong offset!");
static_assert(offsetof(UActionLabel, KeyLabelWidgetClass) == 0x000298, "Member 'UActionLabel::KeyLabelWidgetClass' has a wrong offset!");
static_assert(offsetof(UActionLabel, KeySeparatorWidgetClass) == 0x0002A0, "Member 'UActionLabel::KeySeparatorWidgetClass' has a wrong offset!");
static_assert(offsetof(UActionLabel, KeyContainer) == 0x0002A8, "Member 'UActionLabel::KeyContainer' has a wrong offset!");
static_assert(offsetof(UActionLabel, PrimaryKeyLabel) == 0x0002B0, "Member 'UActionLabel::PrimaryKeyLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, ShiftLabel) == 0x0002B8, "Member 'UActionLabel::ShiftLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, CtrlLabel) == 0x0002C0, "Member 'UActionLabel::CtrlLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, AltLabel) == 0x0002C8, "Member 'UActionLabel::AltLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, CmdLabel) == 0x0002D0, "Member 'UActionLabel::CmdLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, ShiftSeparator) == 0x0002D8, "Member 'UActionLabel::ShiftSeparator' has a wrong offset!");
static_assert(offsetof(UActionLabel, CtrlSeparator) == 0x0002E0, "Member 'UActionLabel::CtrlSeparator' has a wrong offset!");
static_assert(offsetof(UActionLabel, AltSeparator) == 0x0002E8, "Member 'UActionLabel::AltSeparator' has a wrong offset!");
static_assert(offsetof(UActionLabel, CmdSeparator) == 0x0002F0, "Member 'UActionLabel::CmdSeparator' has a wrong offset!");
...
{
public:
	int32                                         MappingGroup;                                      // 0x0260(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UInputMapping) == 0x000298, "Wrong size on UInputMapping");
static_assert(offsetof(UInputMapping, MappingGroup) == 0x000260, "Member 'UInputMapping::MappingGroup' has a wrong offset!");
static_assert(offsetof(UInputMapping, KeyGroup) == 0x000264, "Member 'UInputMapping::KeyGroup' has a wrong offset!");
static_assert(offsetof(UInputMapping, IconTags) == 0x000270, "Member 'UInputMapping::IconTags' has a wrong offset!");
static_assert(offsetof(UInputMapping, BindCaptureButton) == 0x000290, "Member 'UInputMapping::BindCaptureButton' has a wrong offset!");
...
static_assert(sizeof(UActionMapping) == 0x0002A8, "Wrong size on UActionMapping");
static_assert(offsetof(UActionMapping, ActionName) == 0x000298, "Member 'UActionMapping::ActionName' has a wrong offset!");
static_assert(offsetof(UActionMapping, ActionLabel) == 0x0002A0, "Member 'UActionMapping::ActionLabel' has a wrong offset!");
...
static_assert(sizeof(UAxisLabel) == 0x0002A8, "Wrong size on UAxisLabel");
static_assert(offsetof(UAxisLabel, AxisName) == 0x000290, "Member 'UAxisLabel::AxisName' has a wrong offset!");
static_assert(offsetof(UAxisLabel, Scale) == 0x000298, "Member 'UAxisLabel::Scale' has a wrong offset!");
static_assert(offsetof(UAxisLabel, KeyLabel) == 0x0002A0, "Member 'UAxisLabel::KeyLabel' has a wrong offset!");
...
static_assert(sizeof(UAxisMapping) == 0x0002B0, "Wrong size on UAxisMapping");
static_assert(offsetof(UAxisMapping, AxisName) == 0x000298, "Member 'UAxisMapping::AxisName' has a wrong offset!");
static_assert(offsetof(UAxisMapping, Scale) == 0x0002A0, "Member 'UAxisMapping::Scale' has a wrong offset!");
static_assert(offsetof(UAxisMapping, AxisLabel) == 0x0002A8, "Member 'UAxisMapping::AxisLabel' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UBindCapturePrompt>         BindCapturePromptClass;                            // 0x0268(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoClear, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         CapturePromptZOrder;                               // 0x0270(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBindCaptureButton) == 0x000290, "Wrong size on UBindCaptureButton");
static_assert(offsetof(UBindCaptureButton, KeyGroup) == 0x000260, "Member 'UBindCaptureButton::KeyGroup' has a wrong offset!");
static_assert(offsetof(UBindCaptureButton, BindCapturePromptClass) == 0x000268, "Member 'UBindCaptureButton::BindCapturePromptClass' has a wrong offset!");
static_assert(offsetof(UBindCaptureButton, CapturePromptZOrder) == 0x000270, "Member 'UBindCaptureButton::CapturePromptZOrder' has a wrong offset!");
static_assert(offsetof(UBindCaptureButton, Prompt) == 0x000288, "Member 'UBindCaptureButton::Prompt' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_26C[0x4];                                      // 0x026C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(const struct FCapturedInput& CapturedInput)> OnChordCaptured;                                   // 0x0270(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FCapturedInput& CapturedInput)> OnChordRejected;                                   // 0x0280(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(bool bWasCancelled)> OnCapturePromptClosed;                             // 0x0290(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBindCapturePrompt) == 0x0002C0, "Wrong size on UBindCapturePrompt");
static_assert(offsetof(UBindCapturePrompt, bIgnoreGameViewportInputWhileCapturing) == 0x000260, "Member 'UBindCapturePrompt::bIgnoreGameViewportInputWhileCapturing' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, bRestrictKeyGroup) == 0x000261, "Member 'UBindCapturePrompt::bRestrictKeyGroup' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, CaptureMode) == 0x000262, "Member 'UBindCapturePrompt::CaptureMode' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, KeyGroup) == 0x000264, "Member 'UBindCapturePrompt::KeyGroup' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, OnChordCaptured) == 0x000270, "Member 'UBindCapturePrompt::OnChordCaptured' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, OnChordRejected) == 0x000280, "Member 'UBindCapturePrompt::OnChordRejected' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, OnCapturePromptClosed) == 0x000290, "Member 'UBindCapturePrompt::OnCapturePromptClosed' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, KeysDown) == 0x0002A0, "Member 'UBindCapturePrompt::KeysDown' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, PreviousIgnoreInput) == 0x0002B0, "Member 'UBindCapturePrompt::PreviousIgnoreInput' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, AccumulatedMouseDelta) == 0x0002B4, "Member 'UBindCapturePrompt::AccumulatedMouseDelta' has a wrong offset!");
...
public:
	...
	static void SetPlayerInputMappingsStatic(class APlayerController* Player, struct FPlayerInputMappings* Mappings);
...
static_assert(sizeof(UInputMappingManager) == 0x000058, "Wrong size on UInputMappingManager");
static_assert(offsetof(UInputMappingManager, PlayerInputOverrides) == 0x000038, "Member 'UInputMappingManager::PlayerInputOverrides' has a wrong offset!");
static_assert(offsetof(UInputMappingManager, RegisteredPlayerControllers) == 0x000048, "Member 'UInputMappingManager::RegisteredPlayerControllers' has a wrong offset!");
...
static_assert(sizeof(UKeyLabel) == 0x0002D0, "Wrong size on UKeyLabel");
static_assert(offsetof(UKeyLabel, KeyInvalidText) == 0x000260, "Member 'UKeyLabel::KeyInvalidText' has a wrong offset!");
static_assert(offsetof(UKeyLabel, LabelOverride) == 0x000278, "Member 'UKeyLabel::LabelOverride' has a wrong offset!");
static_assert(offsetof(UKeyLabel, Key) == 0x000290, "Member 'UKeyLabel::Key' has a wrong offset!");
static_assert(offsetof(UKeyLabel, AxisScale) == 0x0002A8, "Member 'UKeyLabel::AxisScale' has a wrong offset!");
static_assert(offsetof(UKeyLabel, IconTags) == 0x0002B0, "Member 'UKeyLabel::IconTags' has a wrong offset!");
