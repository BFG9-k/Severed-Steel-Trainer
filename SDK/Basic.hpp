...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05A3DBD0;
	constexpr int32 AppendString      = 0x018D3CD0;
	constexpr int32 GNames            = 0x05A01880;
	constexpr int32 GWorld            = 0x05B85400;
	constexpr int32 ProcessEvent      = 0x01AC4BA0;
