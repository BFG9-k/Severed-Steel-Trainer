...
public:
	...
	TSubclassOf<class USettingValueMask>          ValueMask;                                         // 0x0268(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAutoSettingWidget) == 0x0002B0, "Wrong size on UAutoSettingWidget");
static_assert(offsetof(UAutoSettingWidget, CVarName) == 0x000260, "Member 'UAutoSettingWidget::CVarName' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, ValueMask) == 0x000268, "Member 'UAutoSettingWidget::ValueMask' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bAutoSave) == 0x000270, "Member 'UAutoSettingWidget::bAutoSave' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bAutoApply) == 0x000271, "Member 'UAutoSettingWidget::bAutoApply' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, SettingTags) == 0x000278, "Member 'UAutoSettingWidget::SettingTags' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, CurrentValue) == 0x000298, "Member 'UAutoSettingWidget::CurrentValue' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bHasUnappliedChange) == 0x0002A8, "Member 'UAutoSettingWidget::bHasUnappliedChange' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bHasUnsavedChange) == 0x0002A9, "Member 'UAutoSettingWidget::bHasUnsavedChange' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bUpdatingSettingSelection) == 0x0002AA, "Member 'UAutoSettingWidget::bUpdatingSettingSelection' has a wrong offset!");
...
static_assert(sizeof(UToggleSetting) == 0x0002B0, "Wrong size on UToggleSetting");

// Class AutoSettings.CheckBoxSetting
// 0x0008 (0x02B8 - 0x02B0)
class UCheckBoxSetting final : public UToggleSetting
{
public:
...
static_assert(sizeof(UCheckBoxSetting) == 0x0002B8, "Wrong size on UCheckBoxSetting");
static_assert(offsetof(UCheckBoxSetting, CheckBox) == 0x0002B0, "Member 'UCheckBoxSetting::CheckBox' has a wrong offset!");
...
public:
	...
	TSubclassOf<class USettingOptionFactory>      OptionFactory;                                     // 0x02C0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USelectSetting) == 0x0002D0, "Wrong size on USelectSetting");
static_assert(offsetof(USelectSetting, Options) == 0x0002B0, "Member 'USelectSetting::Options' has a wrong offset!");
static_assert(offsetof(USelectSetting, OptionFactory) == 0x0002C0, "Member 'USelectSetting::OptionFactory' has a wrong offset!");
static_assert(offsetof(USelectSetting, bUpdatingSettingOptions) == 0x0002C8, "Member 'USelectSetting::bUpdatingSettingOptions' has a wrong offset!");
...
static_assert(sizeof(UComboBoxSetting) == 0x0002D8, "Wrong size on UComboBoxSetting");
static_assert(offsetof(UComboBoxSetting, ComboBox) == 0x0002D0, "Member 'UComboBoxSetting::ComboBox' has a wrong offset!");
...
static_assert(sizeof(USliderSetting) == 0x0002B8, "Wrong size on USliderSetting");
static_assert(offsetof(USliderSetting, LeftValue) == 0x0002B0, "Member 'USliderSetting::LeftValue' has a wrong offset!");
static_assert(offsetof(USliderSetting, RightValue) == 0x0002B4, "Member 'USliderSetting::RightValue' has a wrong offset!");

// Class AutoSettings.NativeSliderSetting
// 0x0010 (0x02C8 - 0x02B8)
class UNativeSliderSetting final : public USliderSetting
{
public:
...
static_assert(sizeof(UNativeSliderSetting) == 0x0002C8, "Wrong size on UNativeSliderSetting");
static_assert(offsetof(UNativeSliderSetting, Slider) == 0x0002B8, "Member 'UNativeSliderSetting::Slider' has a wrong offset!");
static_assert(offsetof(UNativeSliderSetting, bMouseCaptureInProgress) == 0x0002C0, "Member 'UNativeSliderSetting::bMouseCaptureInProgress' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(const class FString& Value)> OnSelected;                                        // 0x0260(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URadioButton) == 0x0002A0, "Wrong size on URadioButton");
static_assert(offsetof(URadioButton, OnSelected) == 0x000260, "Member 'URadioButton::OnSelected' has a wrong offset!");
static_assert(offsetof(URadioButton, Label) == 0x000270, "Member 'URadioButton::Label' has a wrong offset!");
static_assert(offsetof(URadioButton, Value) == 0x000288, "Member 'URadioButton::Value' has a wrong offset!");
static_assert(offsetof(URadioButton, Selected) == 0x000298, "Member 'URadioButton::Selected' has a wrong offset!");
...
public:
	...
	TSubclassOf<class URadioButton>               RadioButtonClass;                                  // 0x0270(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoClear, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class FString& Value)> SelectionChangedEvent;                             // 0x0278(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URadioSelect) == 0x0002A0, "Wrong size on URadioSelect");
static_assert(offsetof(URadioSelect, Options) == 0x000260, "Member 'URadioSelect::Options' has a wrong offset!");
static_assert(offsetof(URadioSelect, RadioButtonClass) == 0x000270, "Member 'URadioSelect::RadioButtonClass' has a wrong offset!");
static_assert(offsetof(URadioSelect, SelectionChangedEvent) == 0x000278, "Member 'URadioSelect::SelectionChangedEvent' has a wrong offset!");
static_assert(offsetof(URadioSelect, ButtonContainer) == 0x000288, "Member 'URadioSelect::ButtonContainer' has a wrong offset!");
static_assert(offsetof(URadioSelect, RadioButtons) == 0x000290, "Member 'URadioSelect::RadioButtons' has a wrong offset!");
...
{
public:
	TSubclassOf<class URadioButton>               RadioButtonClass;                                  // 0x02D0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoClear, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URadioSelectSetting) == 0x0002E0, "Wrong size on URadioSelectSetting");
static_assert(offsetof(URadioSelectSetting, RadioButtonClass) == 0x0002D0, "Member 'URadioSelectSetting::RadioButtonClass' has a wrong offset!");
static_assert(offsetof(URadioSelectSetting, RadioSelect) == 0x0002D8, "Member 'URadioSelectSetting::RadioSelect' has a wrong offset!");
...
public:
	...
	class FString                                 IniFilename;                                       // 0x0038(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USettingsManager) == 0x000048, "Wrong size on USettingsManager");
...
static_assert(offsetof(USettingsManager, IniFilename) == 0x000038, "Member 'USettingsManager::IniFilename' has a wrong offset!");
...
static_assert(sizeof(USpinner) == 0x000290, "Wrong size on USpinner");
static_assert(offsetof(USpinner, Options) == 0x000260, "Member 'USpinner::Options' has a wrong offset!");
static_assert(offsetof(USpinner, bAllowWrapping) == 0x000270, "Member 'USpinner::bAllowWrapping' has a wrong offset!");
static_assert(offsetof(USpinner, SelectionChangedEvent) == 0x000278, "Member 'USpinner::SelectionChangedEvent' has a wrong offset!");
...
static_assert(sizeof(USpinnerSetting) == 0x0002D8, "Wrong size on USpinnerSetting");
static_assert(offsetof(USpinnerSetting, Spinner) == 0x0002D0, "Member 'USpinnerSetting::Spinner' has a wrong offset!");
