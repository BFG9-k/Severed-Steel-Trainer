...
static_assert(sizeof(BTTask_FlyTo_Pathfinding_OnFinish) == 0x000288, "Wrong size on BTTask_FlyTo_Pathfinding_OnFinish");
...
static_assert(sizeof(DonNavigationManager_FindPathSolution_StressTesting) == 0x000068, "Wrong size on DonNavigationManager_FindPathSolution_StressTesting");
...
static_assert(offsetof(DonNavigationManager_FindPathSolution_StressTesting, DebugParams) == 0x000058, "Member 'DonNavigationManager_FindPathSolution_StressTesting::DebugParams' has a wrong offset!");
static_assert(offsetof(DonNavigationManager_FindPathSolution_StressTesting, ReturnValue) == 0x000064, "Member 'DonNavigationManager_FindPathSolution_StressTesting::ReturnValue' has a wrong offset!");
...
public:
	...
	TDelegate<void(struct FDoNNavigationQueryData& Data)> ResultHandlerDelegate;                             // 0x0044(0x0010)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
	TDelegate<void(struct FDonNavigationDynamicCollisionPayload& Data)> DynamicCollisionListener;                          // 0x0054(0x0010)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0064(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_65[0x3];                                       // 0x0065(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(DonNavigationManager_SchedulePathfindingTask) == 0x000068, "Wrong size on DonNavigationManager_SchedulePathfindingTask");
...
static_assert(offsetof(DonNavigationManager_SchedulePathfindingTask, QueryParams) == 0x000018, "Member 'DonNavigationManager_SchedulePathfindingTask::QueryParams' has a wrong offset!");
static_assert(offsetof(DonNavigationManager_SchedulePathfindingTask, DebugParams) == 0x000038, "Member 'DonNavigationManager_SchedulePathfindingTask::DebugParams' has a wrong offset!");
static_assert(offsetof(DonNavigationManager_SchedulePathfindingTask, ResultHandlerDelegate) == 0x000044, "Member 'DonNavigationManager_SchedulePathfindingTask::ResultHandlerDelegate' has a wrong offset!");
static_assert(offsetof(DonNavigationManager_SchedulePathfindingTask, DynamicCollisionListener) == 0x000054, "Member 'DonNavigationManager_SchedulePathfindingTask::DynamicCollisionListener' has a wrong offset!");
static_assert(offsetof(DonNavigationManager_SchedulePathfindingTask, ReturnValue) == 0x000064, "Member 'DonNavigationManager_SchedulePathfindingTask::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(DonNavigationManager_StopListeningToDynamicCollisionsForPath) == 0x000298, "Wrong size on DonNavigationManager_StopListeningToDynamicCollisionsForPath");
...
static_assert(sizeof(DonNavigationManager_StopListeningToDynamicCollisionsForPathIndex) == 0x0002A0, "Wrong size on DonNavigationManager_StopListeningToDynamicCollisionsForPathIndex");
...
static_assert(offsetof(DonNavigationManager_StopListeningToDynamicCollisionsForPathIndex, VolumeIndex) == 0x000298, "Member 'DonNavigationManager_StopListeningToDynamicCollisionsForPathIndex::VolumeIndex' has a wrong offset!");
...
static_assert(sizeof(DonNavigationManager_VisualizeDynamicCollisionListeners) == 0x000298, "Wrong size on DonNavigationManager_VisualizeDynamicCollisionListeners");
