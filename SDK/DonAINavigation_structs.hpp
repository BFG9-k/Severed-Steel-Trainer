...
public:
	...
	uint8                                         Pad_48[0x218];                                     // 0x0048(0x0218)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FVector>                        PathSolutionRaw;                                   // 0x0260(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	...
	EDonNavigationQueryStatus                     QueryStatus;                                       // 0x0280(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FDoNNavigationQueryData) == 0x000288, "Wrong size on FDoNNavigationQueryData");
...
static_assert(offsetof(FDoNNavigationQueryData, PathSolutionRaw) == 0x000260, "Member 'FDoNNavigationQueryData::PathSolutionRaw' has a wrong offset!");
static_assert(offsetof(FDoNNavigationQueryData, PathSolutionOptimized) == 0x000270, "Member 'FDoNNavigationQueryData::PathSolutionOptimized' has a wrong offset!");
static_assert(offsetof(FDoNNavigationQueryData, QueryStatus) == 0x000280, "Member 'FDoNNavigationQueryData::QueryStatus' has a wrong offset!");
...
{
public:
	uint8                                         Pad_8[0x148];                                      // 0x0008(0x0148)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDonNavigationDynamicCollisionTask) == 0x000008, "Wrong alignment on FDonNavigationDynamicCollisionTask");
static_assert(sizeof(FDonNavigationDynamicCollisionTask) == 0x000150, "Wrong size on FDonNavigationDynamicCollisionTask");
...
{
public:
	uint8                                         Pad_8[0x290];                                      // 0x0008(0x0290)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(struct FDoNNavigationQueryData& Data)> ResultHandler;                                     // 0x0298(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
	TDelegate<void(struct FDonNavigationDynamicCollisionPayload& Data)> DynamicCollisionListener;                          // 0x02A8(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDonNavigationQueryTask) == 0x000008, "Wrong alignment on FDonNavigationQueryTask");
static_assert(sizeof(FDonNavigationQueryTask) == 0x0002B8, "Wrong size on FDonNavigationQueryTask");
static_assert(offsetof(FDonNavigationQueryTask, ResultHandler) == 0x000298, "Member 'FDonNavigationQueryTask::ResultHandler' has a wrong offset!");
static_assert(offsetof(FDonNavigationQueryTask, DynamicCollisionListener) == 0x0002A8, "Member 'FDonNavigationQueryTask::DynamicCollisionListener' has a wrong offset!");
