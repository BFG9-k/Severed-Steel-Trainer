...
static_assert(sizeof(USteamCoreAsyncAction) == 0x000030, "Wrong size on USteamCoreAsyncAction");
...
public:
	static class USteamCoreUGCAsyncActionCreateItem* CreateItemAsync(class UObject* WorldContextObject, int32 ConsumerAppID, ESteamWorkshopFileType FileType);
...
static_assert(sizeof(USteamCoreSubsystem) == 0x000048, "Wrong size on USteamCoreSubsystem");
...
public:
	static class USteamCoreUGCAsyncActionSendQueryUGCRequest* SendQueryUGCRequestAsync(class UObject* WorldContextObject, const struct FUGCQueryHandle& Handle);
...
{
public:
	TMulticastInlineDelegate<void(struct FSteamAppInstalled& Data)> SteamAppInstalled;                                 // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSteamAppUninstalled& Data)> SteamAppUninstalled;                               // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAppList) == 0x0000A8, "Wrong size on UAppList");
static_assert(offsetof(UAppList, SteamAppInstalled) == 0x000048, "Member 'UAppList::SteamAppInstalled' has a wrong offset!");
static_assert(offsetof(UAppList, SteamAppUninstalled) == 0x000058, "Member 'UAppList::SteamAppUninstalled' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FAddAppDependencyResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionAddAppDependency* AddAppDependencyAsync(class UObject* WorldContextObject, const struct FPublishedFileID& PublishedFileID, int32 AppID);
...
static_assert(sizeof(USteamCoreUGCAsyncActionAddAppDependency) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionAddAppDependency");
static_assert(offsetof(USteamCoreUGCAsyncActionAddAppDependency, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionAddAppDependency::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FDLCInstalled& Data)> DLCInstalled;                                      // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FFileDetailsResult& Data)> FileDetailsResultDelegate;                         // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_68[0x40];                                      // 0x0068(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UApps) == 0x0000A8, "Wrong size on UApps");
static_assert(offsetof(UApps, DLCInstalled) == 0x000048, "Member 'UApps::DLCInstalled' has a wrong offset!");
static_assert(offsetof(UApps, FileDetailsResultDelegate) == 0x000058, "Member 'UApps::FileDetailsResultDelegate' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FFileDetailsResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreAppsAsyncActionGetFileDetails* GetFileDetailsAsync(class UObject* WorldContextObject, const class FString& Filename);
...
static_assert(sizeof(USteamCoreAppsAsyncActionGetFileDetails) == 0x000040, "Wrong size on USteamCoreAppsAsyncActionGetFileDetails");
static_assert(offsetof(USteamCoreAppsAsyncActionGetFileDetails, OnCallback) == 0x000030, "Member 'USteamCoreAppsAsyncActionGetFileDetails::OnCallback' has a wrong offset!");
...
{
public:
	int32                                         DisabledSubsystems;                                // 0x0038(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	int32                                         P2PConnectionTimeout;                              // 0x0048(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SteamAppId;                                        // 0x004C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SteamDevAppId;                                     // 0x0050(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Port;                                              // 0x0054(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         GameServerQueryPort;                               // 0x0058(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5C[0x4];                                       // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 GameVersion;                                       // 0x0060(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USteamCoreSettings) == 0x000070, "Wrong size on USteamCoreSettings");
static_assert(offsetof(USteamCoreSettings, DisabledSubsystems) == 0x000038, "Member 'USteamCoreSettings::DisabledSubsystems' has a wrong offset!");
static_assert(offsetof(USteamCoreSettings, bDebugging) == 0x00003C, "Member 'USteamCoreSettings::bDebugging' has a wrong offset!");
static_assert(offsetof(USteamCoreSettings, AsyncTaskTimeout) == 0x000040, "Member 'USteamCoreSettings::AsyncTaskTimeout' has a wrong offset!");
static_assert(offsetof(USteamCoreSettings, bEnabled) == 0x000044, "Member 'USteamCoreSettings::bEnabled' has a wrong offset!");
static_assert(offsetof(USteamCoreSettings, bRelaunchInSteam) == 0x000045, "Member 'USteamCoreSettings::bRelaunchInSteam' has a wrong offset!");
static_assert(offsetof(USteamCoreSettings, bVACEnabled) == 0x000046, "Member 'USteamCoreSettings::bVACEnabled' has a wrong offset!");
static_assert(offsetof(USteamCoreSettings, bAllowP2PPacketRelay) == 0x000047, "Member 'USteamCoreSettings::bAllowP2PPacketRelay' has a wrong offset!");
static_assert(offsetof(USteamCoreSettings, P2PConnectionTimeout) == 0x000048, "Member 'USteamCoreSettings::P2PConnectionTimeout' has a wrong offset!");
static_assert(offsetof(USteamCoreSettings, SteamAppId) == 0x00004C, "Member 'USteamCoreSettings::SteamAppId' has a wrong offset!");
static_assert(offsetof(USteamCoreSettings, SteamDevAppId) == 0x000050, "Member 'USteamCoreSettings::SteamDevAppId' has a wrong offset!");
static_assert(offsetof(USteamCoreSettings, Port) == 0x000054, "Member 'USteamCoreSettings::Port' has a wrong offset!");
static_assert(offsetof(USteamCoreSettings, GameServerQueryPort) == 0x000058, "Member 'USteamCoreSettings::GameServerQueryPort' has a wrong offset!");
static_assert(offsetof(USteamCoreSettings, GameVersion) == 0x000060, "Member 'USteamCoreSettings::GameVersion' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FAvatarImageLoaded& Data)> AvatarImageLoaded;                                 // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FFriendRichPresenceUpdate& Data)> FriendRichPresenceUpdate;                          // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameConnectedChatJoin& Data)> GameConnectedChatJoin;                             // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameConnectedChatLeave& Data)> GameConnectedChatLeave;                            // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameConnectedClanChatMsg& Data)> GameConnectedClanChatMsg;                          // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameConnectedFriendChatMsg& Data)> GameConnectedFriendChatMsg;                        // 0x0098(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameLobbyJoinRequested& Data)> GameLobbyJoinRequested;                            // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameOverlayActivated& Data)> GameOverlayActivated;                              // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameRichPresenceJoinRequested& Data)> GameRichPresenceJoinRequested;                     // 0x00C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameServerChangeRequested& Data)> GameServerChangeRequested;                         // 0x00D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FPersonaStateChange& Data)> PersonaStateChange;                                // 0x00E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSetPersonaNameResponse& Data)> SetPersonaNameResponse;                            // 0x00F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FJoinClanChatRoomCompletionResult& Data)> JoinClanChatRoomCompletionResult;                  // 0x0108(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FClanOfficerListResponse& Data)> ClanOfficerListResponse;                           // 0x0118(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FDownloadClanActivityCountsResult& Data)> DownloadClanActivityCountsResult;                  // 0x0128(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_138[0x1E0];                                    // 0x0138(0x01E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFriends) == 0x000318, "Wrong size on UFriends");
static_assert(offsetof(UFriends, AvatarImageLoaded) == 0x000048, "Member 'UFriends::AvatarImageLoaded' has a wrong offset!");
static_assert(offsetof(UFriends, FriendRichPresenceUpdate) == 0x000058, "Member 'UFriends::FriendRichPresenceUpdate' has a wrong offset!");
static_assert(offsetof(UFriends, GameConnectedChatJoin) == 0x000068, "Member 'UFriends::GameConnectedChatJoin' has a wrong offset!");
static_assert(offsetof(UFriends, GameConnectedChatLeave) == 0x000078, "Member 'UFriends::GameConnectedChatLeave' has a wrong offset!");
static_assert(offsetof(UFriends, GameConnectedClanChatMsg) == 0x000088, "Member 'UFriends::GameConnectedClanChatMsg' has a wrong offset!");
static_assert(offsetof(UFriends, GameConnectedFriendChatMsg) == 0x000098, "Member 'UFriends::GameConnectedFriendChatMsg' has a wrong offset!");
static_assert(offsetof(UFriends, GameLobbyJoinRequested) == 0x0000A8, "Member 'UFriends::GameLobbyJoinRequested' has a wrong offset!");
static_assert(offsetof(UFriends, GameOverlayActivated) == 0x0000B8, "Member 'UFriends::GameOverlayActivated' has a wrong offset!");
static_assert(offsetof(UFriends, GameRichPresenceJoinRequested) == 0x0000C8, "Member 'UFriends::GameRichPresenceJoinRequested' has a wrong offset!");
static_assert(offsetof(UFriends, GameServerChangeRequested) == 0x0000D8, "Member 'UFriends::GameServerChangeRequested' has a wrong offset!");
static_assert(offsetof(UFriends, PersonaStateChange) == 0x0000E8, "Member 'UFriends::PersonaStateChange' has a wrong offset!");
static_assert(offsetof(UFriends, SetPersonaNameResponse) == 0x0000F8, "Member 'UFriends::SetPersonaNameResponse' has a wrong offset!");
static_assert(offsetof(UFriends, JoinClanChatRoomCompletionResult) == 0x000108, "Member 'UFriends::JoinClanChatRoomCompletionResult' has a wrong offset!");
static_assert(offsetof(UFriends, ClanOfficerListResponse) == 0x000118, "Member 'UFriends::ClanOfficerListResponse' has a wrong offset!");
static_assert(offsetof(UFriends, DownloadClanActivityCountsResult) == 0x000128, "Member 'UFriends::DownloadClanActivityCountsResult' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FSetPersonaNameResponse& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreFriendsAsyncActionSetPersonaName* SetPersonaNameAsync(class UObject* WorldContextObject, const class FString& Name_0);
...
static_assert(sizeof(USteamCoreFriendsAsyncActionSetPersonaName) == 0x000040, "Wrong size on USteamCoreFriendsAsyncActionSetPersonaName");
static_assert(offsetof(USteamCoreFriendsAsyncActionSetPersonaName, OnCallback) == 0x000030, "Member 'USteamCoreFriendsAsyncActionSetPersonaName::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FDownloadClanActivityCountsResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreFriendsAsyncActionDownloadClanActivityCounts* DownloadClanActivityCountsAsync(class UObject* WorldContextObject, const TArray<struct FSteamID>& SteamIDClans);
...
static_assert(sizeof(USteamCoreFriendsAsyncActionDownloadClanActivityCounts) == 0x000040, "Wrong size on USteamCoreFriendsAsyncActionDownloadClanActivityCounts");
static_assert(offsetof(USteamCoreFriendsAsyncActionDownloadClanActivityCounts, OnCallback) == 0x000030, "Member 'USteamCoreFriendsAsyncActionDownloadClanActivityCounts::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FClanOfficerListResponse& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreFriendsAsyncActionRequestClanOfficerList* RequestClanOfficerListAsync(class UObject* WorldContextObject, const struct FSteamID& SteamIDClan);
...
static_assert(sizeof(USteamCoreFriendsAsyncActionRequestClanOfficerList) == 0x000040, "Wrong size on USteamCoreFriendsAsyncActionRequestClanOfficerList");
static_assert(offsetof(USteamCoreFriendsAsyncActionRequestClanOfficerList, OnCallback) == 0x000030, "Member 'USteamCoreFriendsAsyncActionRequestClanOfficerList::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FJoinClanChatRoomCompletionResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreFriendsAsyncActionJoinClanChatRoom* JoinClanChatRoomAsync(class UObject* WorldContextObject, const struct FSteamID& SteamIDClan);
...
static_assert(sizeof(USteamCoreFriendsAsyncActionJoinClanChatRoom) == 0x000040, "Wrong size on USteamCoreFriendsAsyncActionJoinClanChatRoom");
static_assert(offsetof(USteamCoreFriendsAsyncActionJoinClanChatRoom, OnCallback) == 0x000030, "Member 'USteamCoreFriendsAsyncActionJoinClanChatRoom::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FFriendsEnumerateFollowingList& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreFriendsAsyncActionEnumerateFollowingList* EnumerateFollowingListAsync(class UObject* WorldContextObject, int32 StartIndex);
...
static_assert(sizeof(USteamCoreFriendsAsyncActionEnumerateFollowingList) == 0x000040, "Wrong size on USteamCoreFriendsAsyncActionEnumerateFollowingList");
static_assert(offsetof(USteamCoreFriendsAsyncActionEnumerateFollowingList, OnCallback) == 0x000030, "Member 'USteamCoreFriendsAsyncActionEnumerateFollowingList::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FFriendsIsFollowing& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreFriendsAsyncActionIsFollowing* IsFollowingAsync(class UObject* WorldContextObject, const struct FSteamID& SteamID);
...
static_assert(sizeof(USteamCoreFriendsAsyncActionIsFollowing) == 0x000040, "Wrong size on USteamCoreFriendsAsyncActionIsFollowing");
static_assert(offsetof(USteamCoreFriendsAsyncActionIsFollowing, OnCallback) == 0x000030, "Member 'USteamCoreFriendsAsyncActionIsFollowing::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FFriendsGetFollowerCount& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreFriendsAsyncActionGetFollowerCount* GetFollowerCountAsync(class UObject* WorldContextObject, const struct FSteamID& SteamID);
...
static_assert(sizeof(USteamCoreFriendsAsyncActionGetFollowerCount) == 0x000040, "Wrong size on USteamCoreFriendsAsyncActionGetFollowerCount");
static_assert(offsetof(USteamCoreFriendsAsyncActionGetFollowerCount, OnCallback) == 0x000030, "Member 'USteamCoreFriendsAsyncActionGetFollowerCount::OnCallback' has a wrong offset!");
...
public:
	static class USteamCoreFriendsAsyncActionRequestUserInformation* RequestUserInformationAsync(class UObject* WorldContextObject, const struct FSteamID& SteamIDUser, bool bRequireNameOnly);
...
{
public:
	TMulticastInlineDelegate<void(struct FSearchForGameProgressCallback& Data)> SearchForGameProgressDelegate;                     // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSearchForGameResultCallback& Data)> SearchForGameResultDelegate;                       // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FRequestPlayersForGameProgressCallback& Data)> RequestPlayersForGameProgressDelegate;             // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FRequestPlayersForGameResultCallback& Data)> RequestPlayersForGameResultDelegate;               // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FRequestPlayersForGameFinalResultCallback& Data)> RequestPlayersForGameFinalResultDelegate;          // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSubmitPlayerResultResultCallback& Data)> SubmitPlayerResultResultDelegate;                  // 0x0098(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FEndGameResultCallback& Data)> EndGameResultDelegate;                             // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USteamGameSearch) == 0x000198, "Wrong size on USteamGameSearch");
static_assert(offsetof(USteamGameSearch, SearchForGameProgressDelegate) == 0x000048, "Member 'USteamGameSearch::SearchForGameProgressDelegate' has a wrong offset!");
static_assert(offsetof(USteamGameSearch, SearchForGameResultDelegate) == 0x000058, "Member 'USteamGameSearch::SearchForGameResultDelegate' has a wrong offset!");
static_assert(offsetof(USteamGameSearch, RequestPlayersForGameProgressDelegate) == 0x000068, "Member 'USteamGameSearch::RequestPlayersForGameProgressDelegate' has a wrong offset!");
static_assert(offsetof(USteamGameSearch, RequestPlayersForGameResultDelegate) == 0x000078, "Member 'USteamGameSearch::RequestPlayersForGameResultDelegate' has a wrong offset!");
static_assert(offsetof(USteamGameSearch, RequestPlayersForGameFinalResultDelegate) == 0x000088, "Member 'USteamGameSearch::RequestPlayersForGameFinalResultDelegate' has a wrong offset!");
static_assert(offsetof(USteamGameSearch, SubmitPlayerResultResultDelegate) == 0x000098, "Member 'USteamGameSearch::SubmitPlayerResultResultDelegate' has a wrong offset!");
static_assert(offsetof(USteamGameSearch, EndGameResultDelegate) == 0x0000A8, "Member 'USteamGameSearch::EndGameResultDelegate' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FGSPolicyResponse& Data)> GSPolicyResponse;                                  // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGSClientGroupStatus& Data)> GSClientGroupStatus;                               // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FValidateAuthTicketResponse& Data)> GSValidateAuthTicketResponse;                      // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGSClientApprove& Data)> GSClientApprove;                                   // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGSClientDeny& Data)> GSClientDeny;                                      // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USteamGameServer) == 0x000138, "Wrong size on USteamGameServer");
static_assert(offsetof(USteamGameServer, GSPolicyResponse) == 0x000048, "Member 'USteamGameServer::GSPolicyResponse' has a wrong offset!");
static_assert(offsetof(USteamGameServer, GSClientGroupStatus) == 0x000058, "Member 'USteamGameServer::GSClientGroupStatus' has a wrong offset!");
static_assert(offsetof(USteamGameServer, GSValidateAuthTicketResponse) == 0x000068, "Member 'USteamGameServer::GSValidateAuthTicketResponse' has a wrong offset!");
static_assert(offsetof(USteamGameServer, GSClientApprove) == 0x000078, "Member 'USteamGameServer::GSClientApprove' has a wrong offset!");
static_assert(offsetof(USteamGameServer, GSClientDeny) == 0x000088, "Member 'USteamGameServer::GSClientDeny' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FGSStatsUnloaded& Data)> GSStatsUnloaded;                                   // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameServerStats) == 0x000078, "Wrong size on UGameServerStats");
static_assert(offsetof(UGameServerStats, GSStatsUnloaded) == 0x000048, "Member 'UGameServerStats::GSStatsUnloaded' has a wrong offset!");
...
static_assert(sizeof(UInput) == 0x000048, "Wrong size on UInput");
...
{
public:
	TMulticastInlineDelegate<void(struct FSteamInventoryResultReady& Data)> SteamInventoryResultReady;                         // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              SteamInventoryDefinitionUpdate;                    // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSteamInventoryFullUpdate& Data)> SteamInventoryFullUpdate;                          // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSteamInventoryStartPurchaseResult& Data)> SteamInventoryStartPurchaseResult;                 // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSteamInventoryRequestPricesResult& Data)> SteamInventoryRequestPricesResultDelegate;         // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSteamInventoryEligiblePromoItemDefIDs& Data)> SteamInventoryEligiblePromoItemDefIDs;             // 0x0098(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInventory) == 0x000168, "Wrong size on UInventory");
static_assert(offsetof(UInventory, SteamInventoryResultReady) == 0x000048, "Member 'UInventory::SteamInventoryResultReady' has a wrong offset!");
static_assert(offsetof(UInventory, SteamInventoryDefinitionUpdate) == 0x000058, "Member 'UInventory::SteamInventoryDefinitionUpdate' has a wrong offset!");
static_assert(offsetof(UInventory, SteamInventoryFullUpdate) == 0x000068, "Member 'UInventory::SteamInventoryFullUpdate' has a wrong offset!");
static_assert(offsetof(UInventory, SteamInventoryStartPurchaseResult) == 0x000078, "Member 'UInventory::SteamInventoryStartPurchaseResult' has a wrong offset!");
static_assert(offsetof(UInventory, SteamInventoryRequestPricesResultDelegate) == 0x000088, "Member 'UInventory::SteamInventoryRequestPricesResultDelegate' has a wrong offset!");
static_assert(offsetof(UInventory, SteamInventoryEligiblePromoItemDefIDs) == 0x000098, "Member 'UInventory::SteamInventoryEligiblePromoItemDefIDs' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FSteamInventoryEligiblePromoItemDefIDs& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreInventoryAsyncActionRequestEligiblePromoItemDefinitionsIDs* RequestEligiblePromoItemDefinitionsIDsAsync(class UObject* WorldContextObject, const struct FSteamID& SteamID);
...
static_assert(sizeof(USteamCoreInventoryAsyncActionRequestEligiblePromoItemDefinitionsIDs) == 0x000040, "Wrong size on USteamCoreInventoryAsyncActionRequestEligiblePromoItemDefinitionsIDs");
static_assert(offsetof(USteamCoreInventoryAsyncActionRequestEligiblePromoItemDefinitionsIDs, OnCallback) == 0x000030, "Member 'USteamCoreInventoryAsyncActionRequestEligiblePromoItemDefinitionsIDs::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FSteamInventoryRequestPricesResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreInventoryAsyncActionRequestPricesResult* RequestPricesAsync(class UObject* WorldContextObject);
...
static_assert(sizeof(USteamCoreInventoryAsyncActionRequestPricesResult) == 0x000040, "Wrong size on USteamCoreInventoryAsyncActionRequestPricesResult");
static_assert(offsetof(USteamCoreInventoryAsyncActionRequestPricesResult, OnCallback) == 0x000030, "Member 'USteamCoreInventoryAsyncActionRequestPricesResult::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FSteamInventoryStartPurchaseResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreInventoryAsyncActionStartPurchaseResult* StartPurchaseAsync(class UObject* WorldContextObject, const TArray<struct FSteamItemDef>& ItemDefs, const TArray<int32>& Quantity);
...
static_assert(sizeof(USteamCoreInventoryAsyncActionStartPurchaseResult) == 0x000040, "Wrong size on USteamCoreInventoryAsyncActionStartPurchaseResult");
static_assert(offsetof(USteamCoreInventoryAsyncActionStartPurchaseResult, OnCallback) == 0x000030, "Member 'USteamCoreInventoryAsyncActionStartPurchaseResult::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FFavoritesListAccountsUpdated& Data)> FavoritesListAccountsUpdated;                      // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FFavoritesListChanged& Data)> FavoritesListChanged;                              // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FLobbyChatMsg& Data)> LobbyChatMsg;                                      // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FLobbyChatUpdate& Data)> LobbyChatUpdate;                                   // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FLobbyDataUpdate& Data)> LobbyDataUpdate;                                   // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FLobbyEnterData& Data)> LobbyEnter;                                        // 0x0098(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FLobbyGameCreated& Data)> LobbyGameCreated;                                  // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FLobbyInviteData& Data)> LobbyInvite;                                       // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FLobbyKickedData& Data)> LobbyKicked;                                       // 0x00C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D8[0x120];                                     // 0x00D8(0x0120)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMatchmaking) == 0x0001F8, "Wrong size on UMatchmaking");
static_assert(offsetof(UMatchmaking, FavoritesListAccountsUpdated) == 0x000048, "Member 'UMatchmaking::FavoritesListAccountsUpdated' has a wrong offset!");
static_assert(offsetof(UMatchmaking, FavoritesListChanged) == 0x000058, "Member 'UMatchmaking::FavoritesListChanged' has a wrong offset!");
static_assert(offsetof(UMatchmaking, LobbyChatMsg) == 0x000068, "Member 'UMatchmaking::LobbyChatMsg' has a wrong offset!");
static_assert(offsetof(UMatchmaking, LobbyChatUpdate) == 0x000078, "Member 'UMatchmaking::LobbyChatUpdate' has a wrong offset!");
static_assert(offsetof(UMatchmaking, LobbyDataUpdate) == 0x000088, "Member 'UMatchmaking::LobbyDataUpdate' has a wrong offset!");
static_assert(offsetof(UMatchmaking, LobbyEnter) == 0x000098, "Member 'UMatchmaking::LobbyEnter' has a wrong offset!");
static_assert(offsetof(UMatchmaking, LobbyGameCreated) == 0x0000A8, "Member 'UMatchmaking::LobbyGameCreated' has a wrong offset!");
static_assert(offsetof(UMatchmaking, LobbyInvite) == 0x0000B8, "Member 'UMatchmaking::LobbyInvite' has a wrong offset!");
static_assert(offsetof(UMatchmaking, LobbyKicked) == 0x0000C8, "Member 'UMatchmaking::LobbyKicked' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FCreateLobbyData& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreMatchmakingAsyncActionCreateLobby* CreateLobbyAsync(class UObject* WorldContextObject, ESteamLobbyType LobbyType, int32 MaxMembers);
...
static_assert(sizeof(USteamCoreMatchmakingAsyncActionCreateLobby) == 0x000040, "Wrong size on USteamCoreMatchmakingAsyncActionCreateLobby");
static_assert(offsetof(USteamCoreMatchmakingAsyncActionCreateLobby, OnCallback) == 0x000030, "Member 'USteamCoreMatchmakingAsyncActionCreateLobby::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FLobbyMatchList& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreMatchmakingAsyncActionRequestLobbyList* RequestLobbyListAsync(class UObject* WorldContextObject);
...
static_assert(sizeof(USteamCoreMatchmakingAsyncActionRequestLobbyList) == 0x000040, "Wrong size on USteamCoreMatchmakingAsyncActionRequestLobbyList");
static_assert(offsetof(USteamCoreMatchmakingAsyncActionRequestLobbyList, OnCallback) == 0x000030, "Member 'USteamCoreMatchmakingAsyncActionRequestLobbyList::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FJoinLobbyData& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreMatchmakingAsyncActionJoinLobby* JoinLobbyAsync(class UObject* WorldContextObject, const struct FSteamID& SteamIDLobby);
...
static_assert(sizeof(USteamCoreMatchmakingAsyncActionJoinLobby) == 0x000040, "Wrong size on USteamCoreMatchmakingAsyncActionJoinLobby");
static_assert(offsetof(USteamCoreMatchmakingAsyncActionJoinLobby, OnCallback) == 0x000030, "Member 'USteamCoreMatchmakingAsyncActionJoinLobby::OnCallback' has a wrong offset!");
...
static_assert(sizeof(USteamCoreCreateSession) == 0x000138, "Wrong size on USteamCoreCreateSession");
static_assert(offsetof(USteamCoreCreateSession, OnSuccess) == 0x000030, "Member 'USteamCoreCreateSession::OnSuccess' has a wrong offset!");
static_assert(offsetof(USteamCoreCreateSession, OnFailure) == 0x000040, "Member 'USteamCoreCreateSession::OnFailure' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(TArray<struct FSteamSessionResult>& Results)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_40[0x90];                                      // 0x0040(0x0090)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class USteamCoreFindSession* FindSteamCoreSessions(class UObject* WorldContextObject, const TMap<class FString, struct FSteamSessionSearchSetting>& SearchSettings, int32 MaxResults, bool bUseLAN, ESteamSessionFindType ServerType, bool bEmptyServersOnly, bool bSecureServersOnly);
...
static_assert(sizeof(USteamCoreFindSession) == 0x0000D0, "Wrong size on USteamCoreFindSession");
static_assert(offsetof(USteamCoreFindSession, OnCallback) == 0x000030, "Member 'USteamCoreFindSession::OnCallback' has a wrong offset!");
...
public:
	static class USteamCoreDestroySession* DestroySteamCoreSession(class UObject* WorldContextObject);
...
static_assert(sizeof(USteamCoreDestroySession) == 0x000070, "Wrong size on USteamCoreDestroySession");
static_assert(offsetof(USteamCoreDestroySession, OnSuccess) == 0x000030, "Member 'USteamCoreDestroySession::OnSuccess' has a wrong offset!");
static_assert(offsetof(USteamCoreDestroySession, OnFailure) == 0x000040, "Member 'USteamCoreDestroySession::OnFailure' has a wrong offset!");
...
static_assert(sizeof(USteamCoreUpdateSession) == 0x000120, "Wrong size on USteamCoreUpdateSession");
static_assert(offsetof(USteamCoreUpdateSession, OnCallback) == 0x000030, "Member 'USteamCoreUpdateSession::OnCallback' has a wrong offset!");
...
static_assert(sizeof(UMatchmakingServers) == 0x000048, "Wrong size on UMatchmakingServers");
...
{
public:
	TMulticastInlineDelegate<void(struct FGameServerItem& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreMatchmakingServersAsyncActionPingServer* PingServerAsync(class UObject* WorldContextObject, const class FString& IP, int32 Port);
...
static_assert(sizeof(USteamCoreMatchmakingServersAsyncActionPingServer) == 0x000040, "Wrong size on USteamCoreMatchmakingServersAsyncActionPingServer");
static_assert(offsetof(USteamCoreMatchmakingServersAsyncActionPingServer, OnCallback) == 0x000030, "Member 'USteamCoreMatchmakingServersAsyncActionPingServer::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FGameServerItem& Data)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USteamCoreMatchmakingServersAsyncActionRequestServerList) == 0x000050, "Wrong size on USteamCoreMatchmakingServersAsyncActionRequestServerList");
static_assert(offsetof(USteamCoreMatchmakingServersAsyncActionRequestServerList, OnCallback) == 0x000030, "Member 'USteamCoreMatchmakingServersAsyncActionRequestServerList::OnCallback' has a wrong offset!");
static_assert(offsetof(USteamCoreMatchmakingServersAsyncActionRequestServerList, OnRefreshCompleted) == 0x000040, "Member 'USteamCoreMatchmakingServersAsyncActionRequestServerList::OnRefreshCompleted' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(TArray<struct FGameServerRule>& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreMatchmakingServersAsyncActionServerRules* ServerRulesAsync(class UObject* WorldContextObject, const class FString& IP, int32 QueryPort);
...
static_assert(sizeof(USteamCoreMatchmakingServersAsyncActionServerRules) == 0x000040, "Wrong size on USteamCoreMatchmakingServersAsyncActionServerRules");
static_assert(offsetof(USteamCoreMatchmakingServersAsyncActionServerRules, OnCallback) == 0x000030, "Member 'USteamCoreMatchmakingServersAsyncActionServerRules::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FPlaybackStatusHasChanged& Data)> PlaybackStatusHasChanged;                          // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FVolumeHasChanged& Data)> VolumeHasChanged;                                  // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_68[0x40];                                      // 0x0068(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMusic) == 0x0000A8, "Wrong size on UMusic");
static_assert(offsetof(UMusic, PlaybackStatusHasChanged) == 0x000048, "Member 'UMusic::PlaybackStatusHasChanged' has a wrong offset!");
static_assert(offsetof(UMusic, VolumeHasChanged) == 0x000058, "Member 'UMusic::VolumeHasChanged' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FP2PSessionRequest& Data)> OnP2PSessionRequestDelegate;                       // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FP2PSessionConnectFail& Data)> OnP2PSessionConnectFailDelegate;                   // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_68[0x40];                                      // 0x0068(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNetworking) == 0x0000A8, "Wrong size on UNetworking");
static_assert(offsetof(UNetworking, OnP2PSessionRequestDelegate) == 0x000048, "Member 'UNetworking::OnP2PSessionRequestDelegate' has a wrong offset!");
static_assert(offsetof(UNetworking, OnP2PSessionConnectFailDelegate) == 0x000058, "Member 'UNetworking::OnP2PSessionConnectFailDelegate' has a wrong offset!");
...
static_assert(sizeof(UNetworkingUtils) == 0x000048, "Wrong size on UNetworkingUtils");
...
static_assert(sizeof(UParentalSettings) == 0x000048, "Wrong size on UParentalSettings");
...
{
public:
	TMulticastInlineDelegate<void(struct FJoinPartyData& Data)> JoinPartyDelegate;                                 // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FCreateBeaconData& Data)> CreateBeaconDelegate;                              // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FReservationNotificationData& Data)> ReservationNotificationDelegate;                   // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FChangeNumOpenSlotsData& Data)> ChangeNumOpenSlotsDelegate;                        // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              AvailableBeaconLocationsDelegate;                  // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              ActiveBeaconsDelegate;                             // 0x0098(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_A8[0xC0];                                      // 0x00A8(0x00C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USteamParties) == 0x000168, "Wrong size on USteamParties");
static_assert(offsetof(USteamParties, JoinPartyDelegate) == 0x000048, "Member 'USteamParties::JoinPartyDelegate' has a wrong offset!");
static_assert(offsetof(USteamParties, CreateBeaconDelegate) == 0x000058, "Member 'USteamParties::CreateBeaconDelegate' has a wrong offset!");
static_assert(offsetof(USteamParties, ReservationNotificationDelegate) == 0x000068, "Member 'USteamParties::ReservationNotificationDelegate' has a wrong offset!");
static_assert(offsetof(USteamParties, ChangeNumOpenSlotsDelegate) == 0x000078, "Member 'USteamParties::ChangeNumOpenSlotsDelegate' has a wrong offset!");
static_assert(offsetof(USteamParties, AvailableBeaconLocationsDelegate) == 0x000088, "Member 'USteamParties::AvailableBeaconLocationsDelegate' has a wrong offset!");
static_assert(offsetof(USteamParties, ActiveBeaconsDelegate) == 0x000098, "Member 'USteamParties::ActiveBeaconsDelegate' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FJoinPartyData& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreSteamPartiesAsyncActionJoinParty* JoinPartyAsync(class UObject* WorldContextObject, const struct FPartyBeaconID& BeaconID);
...
static_assert(sizeof(USteamCoreSteamPartiesAsyncActionJoinParty) == 0x000040, "Wrong size on USteamCoreSteamPartiesAsyncActionJoinParty");
static_assert(offsetof(USteamCoreSteamPartiesAsyncActionJoinParty, OnCallback) == 0x000030, "Member 'USteamCoreSteamPartiesAsyncActionJoinParty::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FCreateBeaconData& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreSteamPartiesAsyncActionCreateBeacon* CreateBeaconAsync(class UObject* WorldContextObject, int32 OpenSlots, const struct FSteamPartyBeaconLocation& BeaconLocation, const class FString& ConnectString, const class FString& MetaData);
...
static_assert(sizeof(USteamCoreSteamPartiesAsyncActionCreateBeacon) == 0x000040, "Wrong size on USteamCoreSteamPartiesAsyncActionCreateBeacon");
static_assert(offsetof(USteamCoreSteamPartiesAsyncActionCreateBeacon, OnCallback) == 0x000030, "Member 'USteamCoreSteamPartiesAsyncActionCreateBeacon::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FChangeNumOpenSlotsData& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreSteamPartiesAsyncActionChangeNumOpenSlots* ChangeNumOpenSlotsAsync(class UObject* WorldContextObject, const struct FPartyBeaconID& BeaconID, int32 OpenSlots);
...
static_assert(sizeof(USteamCoreSteamPartiesAsyncActionChangeNumOpenSlots) == 0x000040, "Wrong size on USteamCoreSteamPartiesAsyncActionChangeNumOpenSlots");
static_assert(offsetof(USteamCoreSteamPartiesAsyncActionChangeNumOpenSlots, OnCallback) == 0x000030, "Member 'USteamCoreSteamPartiesAsyncActionChangeNumOpenSlots::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FSteamRemotePlaySessionConnected& Data)> SteamRemotePlaySessionConnected;                   // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSteamRemotePlaySessionDisconnected& Data)> SteamRemotePlaySessionDisconnected;                // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_68[0x40];                                      // 0x0068(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URemotePlay) == 0x0000A8, "Wrong size on URemotePlay");
static_assert(offsetof(URemotePlay, SteamRemotePlaySessionConnected) == 0x000048, "Member 'URemotePlay::SteamRemotePlaySessionConnected' has a wrong offset!");
static_assert(offsetof(URemotePlay, SteamRemotePlaySessionDisconnected) == 0x000058, "Member 'URemotePlay::SteamRemotePlaySessionDisconnected' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FRemoteStorageUnsubscribePublishedFileResult& Data)> RemoteStorageUnsubscribePublishedFileResult;       // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FRemoteStorageSubscribePublishedFileResult& Data)> RemoteStorageSubscribePublishedFileResult;         // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FRemoteStoragePublishedFileUnsubscribed& Data)> RemoteStoragePublishedFileUnsubscribed;            // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FRemoteStoragePublishedFileSubscribed& Data)> RemoteStoragePublishedFileSubscribed;              // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URemoteStorage) == 0x000108, "Wrong size on URemoteStorage");
static_assert(offsetof(URemoteStorage, RemoteStorageUnsubscribePublishedFileResult) == 0x000048, "Member 'URemoteStorage::RemoteStorageUnsubscribePublishedFileResult' has a wrong offset!");
static_assert(offsetof(URemoteStorage, RemoteStorageSubscribePublishedFileResult) == 0x000058, "Member 'URemoteStorage::RemoteStorageSubscribePublishedFileResult' has a wrong offset!");
static_assert(offsetof(URemoteStorage, RemoteStoragePublishedFileUnsubscribed) == 0x000068, "Member 'URemoteStorage::RemoteStoragePublishedFileUnsubscribed' has a wrong offset!");
static_assert(offsetof(URemoteStorage, RemoteStoragePublishedFileSubscribed) == 0x000078, "Member 'URemoteStorage::RemoteStoragePublishedFileSubscribed' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FScreenshotReady& Data)> ScreenshotReady;                                   // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FScreenshotRequested& Data)> ScreenshotRequested;                               // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_68[0x40];                                      // 0x0068(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UScreenshots) == 0x0000A8, "Wrong size on UScreenshots");
static_assert(offsetof(UScreenshots, ScreenshotReady) == 0x000048, "Member 'UScreenshots::ScreenshotReady' has a wrong offset!");
static_assert(offsetof(UScreenshots, ScreenshotRequested) == 0x000058, "Member 'UScreenshots::ScreenshotRequested' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FItemInstalled& Data)> ItemInstalled;                                     // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FDownloadItemResult& Data)> DownloadItemResult;                                // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_68[0x40];                                      // 0x0068(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UUGC) == 0x0000A8, "Wrong size on UUGC");
static_assert(offsetof(UUGC, ItemInstalled) == 0x000048, "Member 'UUGC::ItemInstalled' has a wrong offset!");
static_assert(offsetof(UUGC, DownloadItemResult) == 0x000058, "Member 'UUGC::DownloadItemResult' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FStopPlaytimeTrackingResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionStopPlaytimeTrackingForAllItems* StopPlaytimeTrackingForAllItemsAsync(class UObject* WorldContextObject);
...
static_assert(sizeof(USteamCoreUGCAsyncActionStopPlaytimeTrackingForAllItems) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionStopPlaytimeTrackingForAllItems");
static_assert(offsetof(USteamCoreUGCAsyncActionStopPlaytimeTrackingForAllItems, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionStopPlaytimeTrackingForAllItems::OnCallback' has a wrong offset!");
...
public:
	static class USteamCoreUGCAsyncActionStopPlaytimeTracking* StopPlaytimeTrackingAsync(class UObject* WorldContextObject, const TArray<struct FPublishedFileID>& PublishedFileIDs);
...
static_assert(sizeof(USteamCoreUGCAsyncActionStopPlaytimeTracking) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionStopPlaytimeTracking");
static_assert(offsetof(USteamCoreUGCAsyncActionStopPlaytimeTracking, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionStopPlaytimeTracking::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FStartPlaytimeTrackingResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionStartPlaytimeTracking* StartPlaytimeTrackingAsync(class UObject* WorldContextObject, const TArray<struct FPublishedFileID>& PublishedFileIDs);
...
static_assert(sizeof(USteamCoreUGCAsyncActionStartPlaytimeTracking) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionStartPlaytimeTracking");
static_assert(offsetof(USteamCoreUGCAsyncActionStartPlaytimeTracking, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionStartPlaytimeTracking::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FRemoteStorageSubscribePublishedFileResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionUnsubscribeItem* UnsubscribeItemAsync(class UObject* WorldContextObject, const struct FPublishedFileID& PublishedFileIDs);
...
static_assert(sizeof(USteamCoreUGCAsyncActionUnsubscribeItem) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionUnsubscribeItem");
static_assert(offsetof(USteamCoreUGCAsyncActionUnsubscribeItem, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionUnsubscribeItem::OnCallback' has a wrong offset!");
...
public:
	static class USteamCoreUGCAsyncActionSubscribeItem* SubscribeItemAsync(class UObject* WorldContextObject, const struct FPublishedFileID& PublishedFileIDs);
...
static_assert(sizeof(USteamCoreUGCAsyncActionSubscribeItem) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionSubscribeItem");
static_assert(offsetof(USteamCoreUGCAsyncActionSubscribeItem, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionSubscribeItem::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FUserFavoriteItemsListChanged& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionRemoveItemFromFavorites* RemoveItemFromFavoritesAsync(class UObject* WorldContextObject, int32 AppID, const struct FPublishedFileID& PublishedFileID);
...
static_assert(sizeof(USteamCoreUGCAsyncActionRemoveItemFromFavorites) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionRemoveItemFromFavorites");
static_assert(offsetof(USteamCoreUGCAsyncActionRemoveItemFromFavorites, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionRemoveItemFromFavorites::OnCallback' has a wrong offset!");
...
public:
	static class USteamCoreUGCAsyncActionAddItemToFavorites* AddItemToFavoritesAsync(class UObject* WorldContextObject, int32 AppID, const struct FPublishedFileID& PublishedFileID);
...
static_assert(sizeof(USteamCoreUGCAsyncActionAddItemToFavorites) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionAddItemToFavorites");
static_assert(offsetof(USteamCoreUGCAsyncActionAddItemToFavorites, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionAddItemToFavorites::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FGetUserItemVoteResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionGetUserItemVote* GetUserItemVoteAsync(class UObject* WorldContextObject, const struct FPublishedFileID& PublishedFileID);
...
static_assert(sizeof(USteamCoreUGCAsyncActionGetUserItemVote) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionGetUserItemVote");
static_assert(offsetof(USteamCoreUGCAsyncActionGetUserItemVote, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionGetUserItemVote::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FSetUserItemVoteResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionSetUserItemVote* SetUserItemVoteAsync(class UObject* WorldContextObject, const struct FPublishedFileID& PublishedFileID, bool bVoteUp);
...
static_assert(sizeof(USteamCoreUGCAsyncActionSetUserItemVote) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionSetUserItemVote");
static_assert(offsetof(USteamCoreUGCAsyncActionSetUserItemVote, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionSetUserItemVote::OnCallback' has a wrong offset!");
...
public:
	static class USteamCoreUGCAsyncActionSubmitItemUpdate* SubmitItemUpdateAsync(class UObject* WorldContextObject, const struct FUGCUpdateHandle& Handle, const class FString& ChangeNote);
...
{
public:
	TMulticastInlineDelegate<void(struct FRemoveAppDependencyResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionRemoveAppDependency* RemoveAppDependencyAsync(class UObject* WorldContextObject, const struct FPublishedFileID& PublishedFileID, int32 AppID);
...
static_assert(sizeof(USteamCoreUGCAsyncActionRemoveAppDependency) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionRemoveAppDependency");
static_assert(offsetof(USteamCoreUGCAsyncActionRemoveAppDependency, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionRemoveAppDependency::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FAddUGCDependencyResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionAddUGCDependency* AddDependencyAsync(class UObject* WorldContextObject, const struct FPublishedFileID& PublishedFileID, const struct FPublishedFileID& ChildPublishedFileId);
...
static_assert(sizeof(USteamCoreUGCAsyncActionAddUGCDependency) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionAddUGCDependency");
static_assert(offsetof(USteamCoreUGCAsyncActionAddUGCDependency, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionAddUGCDependency::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FRemoveUGCDependencyResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionRemoveUGCDependency* RemoveDependencyAsync(class UObject* WorldContextObject, const struct FPublishedFileID& PublishedFileID, const struct FPublishedFileID& ChildPublishedFileId);
...
static_assert(sizeof(USteamCoreUGCAsyncActionRemoveUGCDependency) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionRemoveUGCDependency");
static_assert(offsetof(USteamCoreUGCAsyncActionRemoveUGCDependency, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionRemoveUGCDependency::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FUGCDeleteItemResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionDeleteItem* DeleteItemAsync(class UObject* WorldContextObject, const struct FPublishedFileID& PublishedFileID);
...
static_assert(sizeof(USteamCoreUGCAsyncActionDeleteItem) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionDeleteItem");
static_assert(offsetof(USteamCoreUGCAsyncActionDeleteItem, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionDeleteItem::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FGetAppDependenciesResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionGetAppDependencies* GetAppDependenciesAsync(class UObject* WorldContextObject, const struct FPublishedFileID& PublishedFileID);
...
static_assert(sizeof(USteamCoreUGCAsyncActionGetAppDependencies) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionGetAppDependencies");
static_assert(offsetof(USteamCoreUGCAsyncActionGetAppDependencies, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionGetAppDependencies::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FDownloadItemResult& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUGCAsyncActionDownloadItem* DownloadItemAsync(class UObject* WorldContextObject, const struct FPublishedFileID& PublishedFileID, bool bHighPriority);
...
static_assert(sizeof(USteamCoreUGCAsyncActionDownloadItem) == 0x000040, "Wrong size on USteamCoreUGCAsyncActionDownloadItem");
static_assert(offsetof(USteamCoreUGCAsyncActionDownloadItem, OnCallback) == 0x000030, "Member 'USteamCoreUGCAsyncActionDownloadItem::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FClientGameServerDeny& Data)> ClientGameServerDeny;                              // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameWebCallback& Data)> GameWebCallback;                                   // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGetAuthSessionTicketResponse& Data)> GetAuthSessionTicketResponse;                      // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FIPCFailure& Data)> IPCFailure;                                        // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FLicensesUpdated& Data)> LicensesUpdated;                                   // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FMicroTxnAuthorizationResponse& Data)> MicroTxnAuthorizationResponse;                     // 0x0098(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSteamServerConnectFailure& Data)> SteamServerConnectFailure;                         // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSteamServersConnected& Data)> SteamServersConnected;                             // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSteamServersDisconnected& Data)> SteamServersDisconnected;                          // 0x00C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FValidateAuthTicketResponse& Data)> ValidateAuthTicketResponse;                        // 0x00D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FEncryptedAppTicketResponse& Data)> EncryptedAppTicketResponse;                        // 0x00E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_F8[0x160];                                     // 0x00F8(0x0160)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UUser) == 0x000258, "Wrong size on UUser");
static_assert(offsetof(UUser, ClientGameServerDeny) == 0x000048, "Member 'UUser::ClientGameServerDeny' has a wrong offset!");
static_assert(offsetof(UUser, GameWebCallback) == 0x000058, "Member 'UUser::GameWebCallback' has a wrong offset!");
static_assert(offsetof(UUser, GetAuthSessionTicketResponse) == 0x000068, "Member 'UUser::GetAuthSessionTicketResponse' has a wrong offset!");
static_assert(offsetof(UUser, IPCFailure) == 0x000078, "Member 'UUser::IPCFailure' has a wrong offset!");
static_assert(offsetof(UUser, LicensesUpdated) == 0x000088, "Member 'UUser::LicensesUpdated' has a wrong offset!");
static_assert(offsetof(UUser, MicroTxnAuthorizationResponse) == 0x000098, "Member 'UUser::MicroTxnAuthorizationResponse' has a wrong offset!");
static_assert(offsetof(UUser, SteamServerConnectFailure) == 0x0000A8, "Member 'UUser::SteamServerConnectFailure' has a wrong offset!");
static_assert(offsetof(UUser, SteamServersConnected) == 0x0000B8, "Member 'UUser::SteamServersConnected' has a wrong offset!");
static_assert(offsetof(UUser, SteamServersDisconnected) == 0x0000C8, "Member 'UUser::SteamServersDisconnected' has a wrong offset!");
static_assert(offsetof(UUser, ValidateAuthTicketResponse) == 0x0000D8, "Member 'UUser::ValidateAuthTicketResponse' has a wrong offset!");
static_assert(offsetof(UUser, EncryptedAppTicketResponse) == 0x0000E8, "Member 'UUser::EncryptedAppTicketResponse' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FEncryptedAppTicketResponse& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUserAsyncActionRequestEncryptedAppTicket* RequestEncryptedAppTicketAsync(class UObject* WorldContextObject, const TArray<uint8>& DataToInclude);
...
static_assert(sizeof(USteamCoreUserAsyncActionRequestEncryptedAppTicket) == 0x000040, "Wrong size on USteamCoreUserAsyncActionRequestEncryptedAppTicket");
static_assert(offsetof(USteamCoreUserAsyncActionRequestEncryptedAppTicket, OnCallback) == 0x000030, "Member 'USteamCoreUserAsyncActionRequestEncryptedAppTicket::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FStoreAuthURLResponse& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUserAsyncActionRequestStoreAuthURL* RequestStoreAuthURLAsync(class UObject* WorldContextObject, const class FString& RedirectURL);
...
static_assert(sizeof(USteamCoreUserAsyncActionRequestStoreAuthURL) == 0x000040, "Wrong size on USteamCoreUserAsyncActionRequestStoreAuthURL");
static_assert(offsetof(USteamCoreUserAsyncActionRequestStoreAuthURL, OnCallback) == 0x000030, "Member 'USteamCoreUserAsyncActionRequestStoreAuthURL::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FUserAchievementIconFetched& Data)> UserAchievementIconFetched;                        // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FUserAchievementStored& Data)> UserAchievementStored;                             // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_68[0x18];                                      // 0x0068(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(struct FUserStatsStored& Data)> UserStatsStored;                                   // 0x0080(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FUserStatsUnloaded& Data)> UserStatsUnloaded;                                 // 0x0090(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UUserStats) == 0x000140, "Wrong size on UUserStats");
static_assert(offsetof(UUserStats, UserAchievementIconFetched) == 0x000048, "Member 'UUserStats::UserAchievementIconFetched' has a wrong offset!");
static_assert(offsetof(UUserStats, UserAchievementStored) == 0x000058, "Member 'UUserStats::UserAchievementStored' has a wrong offset!");
static_assert(offsetof(UUserStats, UserStatsStored) == 0x000080, "Member 'UUserStats::UserStatsStored' has a wrong offset!");
static_assert(offsetof(UUserStats, UserStatsUnloaded) == 0x000090, "Member 'UUserStats::UserStatsUnloaded' has a wrong offset!");
...
public:
	static class USteamCoreUserStatsAsyncActionFindLeaderboard* FindLeaderboardAsync(class UObject* WorldContextObject, const class FString& LeaderboardName);
...
public:
	static class USteamCoreUserStatsAsyncActionDownloadLeaderboardEntries* DownloadLeaderboardEntriesAsync(class UObject* WorldContextObject, const struct FSteamLeaderboard& SteamLeaderboard, ESteamLeaderboardDataRequest Request, int32 RangeStart, int32 RangeEnd);
...
{
public:
	TMulticastInlineDelegate<void(struct FGlobalStatsReceived& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUserStatsAsyncActionDownloadRequestGlobalStats* RequestGlobalStatsAsync(class UObject* WorldContextObject, int32 HistoryDays);
...
static_assert(sizeof(USteamCoreUserStatsAsyncActionDownloadRequestGlobalStats) == 0x000040, "Wrong size on USteamCoreUserStatsAsyncActionDownloadRequestGlobalStats");
static_assert(offsetof(USteamCoreUserStatsAsyncActionDownloadRequestGlobalStats, OnCallback) == 0x000030, "Member 'USteamCoreUserStatsAsyncActionDownloadRequestGlobalStats::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FGlobalAchievementPercentagesReady& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUserStatsAsyncActionRequestGlobalAchievementPercentages* RequestGlobalAchievementPercentagesAsync(class UObject* WorldContextObject);
...
static_assert(sizeof(USteamCoreUserStatsAsyncActionRequestGlobalAchievementPercentages) == 0x000040, "Wrong size on USteamCoreUserStatsAsyncActionRequestGlobalAchievementPercentages");
static_assert(offsetof(USteamCoreUserStatsAsyncActionRequestGlobalAchievementPercentages, OnCallback) == 0x000030, "Member 'USteamCoreUserStatsAsyncActionRequestGlobalAchievementPercentages::OnCallback' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FNumberOfCurrentPlayers& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUserStatsAsyncActionGetNumberOfCurrentPlayers* GetNumberOfCurrentPlayersAsync(class UObject* WorldContextObject);
...
static_assert(sizeof(USteamCoreUserStatsAsyncActionGetNumberOfCurrentPlayers) == 0x000040, "Wrong size on USteamCoreUserStatsAsyncActionGetNumberOfCurrentPlayers");
static_assert(offsetof(USteamCoreUserStatsAsyncActionGetNumberOfCurrentPlayers, OnCallback) == 0x000030, "Member 'USteamCoreUserStatsAsyncActionGetNumberOfCurrentPlayers::OnCallback' has a wrong offset!");
...
public:
	static class USteamCoreUserStatsAsyncActionUploadLeaderboardScore* UploadLeaderboardScoreAsync(class UObject* WorldContextObject, const struct FSteamLeaderboard& SteamLeaderboard, ESteamLeaderboardUploadScoreMethod UploadScoreMethod, int32 Score, const TArray<int32>& ScoreDetails);
...
public:
	static class USteamCoreUserStatsAsyncActionFindOrCreateLeaderboard* FindOrCreateLeaderboardAsync(class UObject* WorldContextObject, const class FString& LeaderboardName, ESteamLeaderboardSortMethod SortMethod, ESteamLeaderboardDisplayType DisplayType);
...
{
public:
	TMulticastInlineDelegate<void(struct FRequestUserStatsData& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUserStatsAsyncActionRequestUserStats* RequestUserStatsAsync(class UObject* WorldContextObject, const struct FSteamID& SteamID);
...
static_assert(sizeof(USteamCoreUserStatsAsyncActionRequestUserStats) == 0x000040, "Wrong size on USteamCoreUserStatsAsyncActionRequestUserStats");
static_assert(offsetof(USteamCoreUserStatsAsyncActionRequestUserStats, OnCallback) == 0x000030, "Member 'USteamCoreUserStatsAsyncActionRequestUserStats::OnCallback' has a wrong offset!");
...
public:
	static class USteamCoreUserStatsAsyncActionDownloadLeaderboardEntriesForUsers* DownloadLeaderboardEntriesForUsersAsync(class UObject* WorldContextObject, const struct FSteamLeaderboard& SteamLeaderboard, const TArray<struct FSteamID>& Users);
...
{
public:
	TMulticastInlineDelegate<void(struct FAttachLeaderboardUGCData& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class USteamCoreUserStatsAsyncActionAttachLeaderboardUGC* AttachLeaderboardUGCAsync(class UObject* WorldContextObject, const struct FSteamLeaderboard& SteamLeaderboard, const struct FSteamUGCHandle& Handle);
...
static_assert(sizeof(USteamCoreUserStatsAsyncActionAttachLeaderboardUGC) == 0x000040, "Wrong size on USteamCoreUserStatsAsyncActionAttachLeaderboardUGC");
static_assert(offsetof(USteamCoreUserStatsAsyncActionAttachLeaderboardUGC, OnCallback) == 0x000030, "Member 'USteamCoreUserStatsAsyncActionAttachLeaderboardUGC::OnCallback' has a wrong offset!");
...
public:
	...
	static bool GetBool(const struct FSteamSessionSetting& Settings, class FString* Key);
	static struct FHostPingData GetHostPingData();
	static int32 GetInteger(const struct FSteamSessionSetting& Settings, class FString* Key);
	...
	static class FString GetString(const struct FSteamSessionSetting& Settings, class FString* Key);
...
{
public:
	TMulticastInlineDelegate<void(struct FCheckFileSignature& Data)> CheckFileSignature;                                // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGamepadTextInputDismissed& Data)> GamepadTextInputDismissed;                         // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FIPCountry& Data)> IPCountry;                                         // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FLowBatteryPower& Data)> LowBatteryPower;                                   // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FSteamShutdown& Data)> SteamShutdown;                                     // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_98[0xA0];                                      // 0x0098(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UUtils) == 0x000138, "Wrong size on UUtils");
static_assert(offsetof(UUtils, CheckFileSignature) == 0x000048, "Member 'UUtils::CheckFileSignature' has a wrong offset!");
static_assert(offsetof(UUtils, GamepadTextInputDismissed) == 0x000058, "Member 'UUtils::GamepadTextInputDismissed' has a wrong offset!");
static_assert(offsetof(UUtils, IPCountry) == 0x000068, "Member 'UUtils::IPCountry' has a wrong offset!");
static_assert(offsetof(UUtils, LowBatteryPower) == 0x000078, "Member 'UUtils::LowBatteryPower' has a wrong offset!");
static_assert(offsetof(UUtils, SteamShutdown) == 0x000088, "Member 'UUtils::SteamShutdown' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FGetOPFSettingsResult& Data)> GetOPFSettingsResult;                              // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGetVideoURLResult& Data)> GetVideoURLResult;                                 // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_68[0x40];                                      // 0x0068(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UVideo) == 0x0000A8, "Wrong size on UVideo");
static_assert(offsetof(UVideo, GetOPFSettingsResult) == 0x000048, "Member 'UVideo::GetOPFSettingsResult' has a wrong offset!");
static_assert(offsetof(UVideo, GetVideoURLResult) == 0x000058, "Member 'UVideo::GetVideoURLResult' has a wrong offset!");
