...
void UEngine_PostRender::hk_PostRender(SDK::UObject* ViewportClient, SDK::UCanvas* Canvas)
{
    ...
    SDK::APlayerCharacter_BP_Manny_C* Steel = reinterpret_cast<SDK::APlayerCharacter_BP_Manny_C*>(Global_Variables::pPlayerController->Character);
    if (Steel)
    {
        ...
        {
            // Fast wallrun
            Steel->WallRunSpeed = 1000.f;
            Steel->WallRunGravityScale = 0.f;

            // Score hack
            Steel->CurrentMultiplierMeter = 1000000.f;
            ...
            if (Trainer_Features::bExploit_SpeedhackEnabled)
            {
                ...
                Steel->CharacterMovement->MaxWalkSpeed = 10000.f;
            }
            ...
            if (Trainer_Features::bExploit_JumphackEnabled)
            {
                ...
                Steel->CharacterMovement->JumpZVelocity = 10000.f;
            }
        }
    }
